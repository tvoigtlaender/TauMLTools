...
def prepare_filelists(sample_alias, path_to_input, path_to_pred, path_to_target, path_to_artifacts, tau_type, original_alias):
    ...
    if path_to_target is not None:
        ...
        if path_to_input==path_to_pred==path_to_target:
            ...
            if not os.path.exists(json_filemap_name):
                ...
                # check_match_and_save(f'{path_to_artifacts}/predictions/{sample_alias}/*/{tau_type}/predictions.h5', f'root://eosuser.cern.ch//eos/cms/store/group/phys_tau/TauML/prod_2018_v2/full_tuples/{original_alias}/*.root', json_filemap_name)
